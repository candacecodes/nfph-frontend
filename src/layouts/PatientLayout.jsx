...
import Header from '../patient-components/Header.jsx';
import Sidebar from '../patient-components/Sidebar.jsx';
import Footer from '../patient-components/Footer.jsx';
...
const PatientLayout = (props) => {
    ...
    return (
        ...
        >
            ...
            {/* Sidebar                                                                        */}
            {/*--------------------------------------------------------------------------------*/}
            <Sidebar {...props} routes={PatientRoutes} />
            {/*--------------------------------------------------------------------------------*/}
            {/* Page Main-Content                                                              */}
            {/*--------------------------------------------------------------------------------*/}
